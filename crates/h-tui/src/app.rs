...
/// The remaining-context bar: ten cells, the filled share as solid blocks and
/// the rest as light shades, run through the rainbow ramp as one string with
/// the percentage.
fn context_bar(fraction: f64) -> String {
